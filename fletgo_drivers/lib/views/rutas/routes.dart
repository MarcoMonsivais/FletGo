...
import 'package:fletgo_user_app/views/rutas/routesAdd.dart';
            ...
            Column(
              ...
              children: [
                ListView(
                  ...
                  children: [
                    StreamBuilder(
                      stream: _db.collection('socios').document(widget.uuidUser).collection('Routes').snapshots(),
                              ...
                              return ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    return Card(
                                      child: ListTile(
                                        onTap: (){
                                          Navigator.push(context,MaterialPageRoute(builder: (context) => seeRoutePage(widget.uuidUser,ds.documentID)));
                                          },
