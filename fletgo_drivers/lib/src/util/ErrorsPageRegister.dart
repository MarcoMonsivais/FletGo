...
class ErrorsPageRegister extends StatefulWidget {

  ErrorsPageRegister(this.messageError, this.locationError);

  final String messageError;
  final String locationError;

  @override
  State<StatefulWidget> createState() => _ErrorsPageRegisterState();
}

class _ErrorsPageRegisterState extends State<ErrorsPageRegister> {
  @override
