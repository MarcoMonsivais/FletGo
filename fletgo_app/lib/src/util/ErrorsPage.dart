        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Text(
                "¡Oops hubo un error en tu pedido!",
              ...
              SizedBox(height: fletgoPadding),
              Text(
                "Tu orden tiene un error.\nReportaremos este error con el equipo FletGo. Porfavor revisa de nuevo tu orden y valida que todo este correcto.",
                textAlign: TextAlign.center,
                style: TextStyle(
